...
const LeaveRequest: React.FC = () => {
    ...
    return (
        <div className="h-screen flex flex-col bg-gradient-to-br from-gray-100 via-gray-200 to-gray-300 overflow-hidden">
            ...
            <main className="flex-1 flex flex-col min-h-0 overflow-auto px-6 py-8">
                {/* Page Header Container - Fixed height section */}
                    ...
                    <div className="flex flex-col md:flex-row md:items-end justify-between mb-6 gap-4">
                        ...
                        <div className="flex items-center gap-3">
                            <button
                                ...
                                className="group flex items-center gap-2 px-5 py-2.5 bg-blue-600 hover:bg-blue-700 text-white rounded-xl transition-all active:scale-95 text-sm font-bold shadow-lg shadow-blue-200 flex-shrink-0"
                            >
                                <svg
                ...
                <div className="flex-shrink-0 mt-4 text-xs text-center text-slate-400 border-t pt-4">
